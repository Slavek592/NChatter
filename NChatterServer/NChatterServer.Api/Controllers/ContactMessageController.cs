...
namespace NChatterServer.Api.Controllers
{
    ...
    public class ContactMessageController : ControllerBase
    {
        ...
        [HttpGet("")]
        public async Task<ActionResult<IEnumerable<MessageModel>>> GetAll(int idUser, int idContact, DateTime from, DateTime to)
        {
            try
            {
                Contact test = await _contactService.ReadContact(idContact);
        ...
        [HttpPost("")]
        public async Task<ActionResult> Post(int idUser, int idContact, Message message)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Put(int idUser, int idContact, int id, Message message)
        {
            try
            {
                Contact contact = await _contactService.ReadContact(idContact);
